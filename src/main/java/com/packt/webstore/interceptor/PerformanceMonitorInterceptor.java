...
public class PerformanceMonitorInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		logger.info("Przetwarzanie ¿¹dania do œcie¿ki: " + getURLPatch(request));
		logger.info("Przetwarzanie ¿¹dania rozpoczêto o: " + getCurrentTime());
		return true;
	}


	private String getURLPatch(HttpServletRequest request) {
	...
	private String getCurrentTime() {
		DateFormat formatter = new SimpleDateFormat("dd/MM/yy 'o' hh:mm:ss");
