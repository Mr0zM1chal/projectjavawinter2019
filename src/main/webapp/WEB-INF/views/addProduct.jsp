			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						<form:errors path="productId" cssClass="alert alert-danger" element="div"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						<form:errors path="unitsInStock" cssClass="alert alert-danger" element="div"/>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="productManualPdf"> <spring:message
							code="addProduct.form.productManualPdf.label" />
					</label>
					<div class="col-lg-10">
						<form:input id="productManualPdf" path="productManualPdf" type="file"
							class="form:input-large" />
					</div>
				</div>
